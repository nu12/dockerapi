...
class Docker::API::Task < Docker::API::Base
    ...
    # Docker Doc: https://docs.docker.com/engine/api/v1.40/#operation/TaskList
    #
    ...
    # Docker Doc: https://docs.docker.com/engine/api/v1.40/#operation/TaskInspect
    #
    ...
    # Docker Doc: https://docs.docker.com/engine/api/v1.40/#operation/TaskLogs
    #
    # @param name (String) : The ID or name of the task.
    # @param params (Hash) : Parameters that are appended to the URL.
