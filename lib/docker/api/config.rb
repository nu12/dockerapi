...
class Docker::API::Config < Docker::API::Base
    ...
    # Docker Doc: https://docs.docker.com/engine/api/v1.40/#operation/ConfigList
    #
    ...
    # Docker Doc: https://docs.docker.com/engine/api/v1.40/#operation/ConfigCreate
    #
    ...
    # Docker Doc: https://docs.docker.com/engine/api/v1.40/#operation/ConfigInspect
    #
    ...
    # Docker Doc: https://docs.docker.com/engine/api/v1.40/#operation/ConfigUpdate
    #
    # @param name (String) : The ID or name of the config.
    # @param params (Hash) : Parameters that are appended to the URL.
    # @param body (Hash) : Request body to be sent as json.
    ...
    # Docker Doc: https://docs.docker.com/engine/api/v1.40/#operation/ConfigDelete
    #
    # @param name (String) : The ID or name of the config.
    def delete name
